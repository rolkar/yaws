...
%%%----------------------------------------------------------------------
%%% File    : yaws_soap_srv.erl
%%% Desc    : Proposed changes made by TeliaSonera.
%%% Authors : Jan Nyström <JanHenryNystrom@gmail.com>
%%%           Andreas Hellström <andreas.hellstrom@teliasonera.com>
%%%----------------------------------------------------------------------
%%% - New fields in state record
%%% - New constant: DEFAULT_NUM_OF_WORKERS
%%% - Modified start_link to receive optional NumOfWorkers arg.
%%% - Modified init to receive NumOfWorkers arg.
%%% - Start workers at startup in init_complete()
%%% - Send request/add_wsdl calls to worker process.
%%% - Moved some internal functions to yaws_soap_srv_worker.
%%%----------------------------------------------------------------------
